...
export default function ComparePage() {
	...
	useEffect(() => {
		...
		setLoading(true)
		fetch(`/api/products?q=${encodeURIComponent(searchQuery)}&limit=8`, { signal: controller.signal, cache: "no-store" })
	...
	return (
		<div>
			<div className="mb-6 flex flex-col gap-2 sm:flex-row sm:items-center">
				<Link href="/products" className="flex items-center gap-1 text-sm text-gray-500 hover:text-primary"><ArrowLeft size={18} /> Back to Products</Link>
