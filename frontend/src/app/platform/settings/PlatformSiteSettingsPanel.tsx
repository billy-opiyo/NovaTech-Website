		...
		<div className="space-y-6 pb-12">
			...
			<section className="glass-card space-y-5 p-6">
				...
				<div className="grid gap-4 md:grid-cols-2">
					...
					<label className="block"><span className="text-sm font-medium">WhatsApp message</span><input className={inputClass} value={text("contact", "whatsappMessage")} onChange={(event) => updateSection("contact", "whatsappMessage", event.target.value)} /></label>
