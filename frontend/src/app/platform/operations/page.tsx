...
export default function PlatformOperationsPage() {
	...
	async function changeStoreStatus(tenantId: string, action: "suspend_store" | "reactivate_store") {
