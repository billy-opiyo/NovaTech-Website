...
const sidebarLinks = (basePath: string, store: ReturnType<typeof useStoreContext>) => [
	...
	},
	{
		...
		items: [
			...
			{ icon: WalletCards, label: "Shopper payments", href: getStoreRouteHref(store, `${basePath}/payments`), activeHref: `${basePath}/payments` },
		...
		<div className="flex flex-col h-full">
			...
			<div className="p-4 border-t border-gray-200 dark:border-gray-700">
				<button
					...
					className="destructive-action flex w-full items-center gap-3 rounded-lg border px-3 py-2.5 transition"
				>
