...
const categories = [
  { name: 'Phones', image: 'https://placehold.co/300x200/0070f3/white?text=Phones', slug: 'phones' },
  { name: 'Laptops', image: 'https://placehold.co/300x200/0070f3/white?text=Laptops', slug: 'laptops' },
  { name: 'Tablets', image: 'https://placehold.co/300x200/0070f3/white?text=Tablets', slug: 'tablets' },
  { name: 'Accessories', image: 'https://placehold.co/300x200/0070f3/white?text=Accessories', slug: 'accessories' },
];
  ...
  return (
    <div className="space-y-24">
      ...
      <section className="relative rounded-3xl overflow-hidden glass-card p-8 md:p-16 text-center">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
            Kenya’s most trusted electronics store. Shop latest phones, laptops, and accessories with warranty & fast delivery.
          </p>
          <div className="flex gap-4 justify-center">
            <Link href="/category/phones" className="btn-primary flex items-center gap-2">
              Shop Phones <ArrowRight size={18} />
            </Link>
            <Link href="/deals" className="border border-primary text-primary hover:bg-primary hover:text-white px-6 py-2 rounded-lg transition">
              Today's Deals
            </Link>
          </div>
        </motion.div>
      ...
      <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {categories.map((cat, i) => (
            ...
            >
              <Link href={`/category/${cat.slug}`} className="glass-card block overflow-hidden group">
              ...
              <Link href={`/products/${product.id}`} className="glass-card block group">
                ...
                <div className="mt-2 flex items-baseline gap-2">
                  {product.discountedPrice ? (
                    <>
                      <span className="text-lg font-bold">KES {product.discountedPrice.toLocaleString()}</span>
                      <span className="text-sm line-through text-gray-400">KES {product.price.toLocaleString()}</span>
                    </>
                  ) : (
      ...
      <section className="glass-card p-8 text-center">
        ...
        <p className="text-gray-600 dark:text-gray-300 mb-6">Get exclusive deals and new arrivals straight to your inbox.</p>
