...
export default function AddressesPage() {
	...
	async function remove(id: string) { if (!window.confirm("Remove this saved address?")) return; await fetch(`/api/account/addresses/${id}`, { method: "DELETE" }); await load() }
