...
function AcceptInvitationForm() {
	...
	async function accept() {
		...
		if (response.ok) { addToast("Invitation accepted successfully", "success"); router.push(data.redirectTo || "/manage") }
		else { setMessage(data.message || "Unable to accept invitation"); addToast(data.message || "Unable to accept invitation", "error"); setBusy(false) }
	}
