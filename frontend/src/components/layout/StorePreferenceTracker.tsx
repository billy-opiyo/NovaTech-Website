...
export default function StorePreferenceTracker({ storeSlug }: { storeSlug: string }) {
	const pathname = usePathname()

	useEffect(() => {
		if (pathname.startsWith("/stores") || pathname.startsWith("/manage") || pathname.startsWith("/platform")) return
