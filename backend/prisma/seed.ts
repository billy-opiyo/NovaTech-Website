...
async function main() {
	...
	const admin = await prisma.user.upsert({
		where: { email: "admin@electrobuy.co.ke" },
		update: {},
		create: {
			name: "Admin User",
	...
	const products = await Promise.all([
		prisma.product.create({
			data: {
				...
				images: [
					"https://placehold.co/800x800/1e293b/white?text=iPhone+15+Pro+Max",
				],
		...
		prisma.product.create({
			data: {
				...
				images: [
					"https://placehold.co/800x800/1e293b/white?text=MacBook+Air+M3",
				],
		...
		prisma.product.create({
			data: {
				...
				images: [
					"https://placehold.co/800x800/1e293b/white?text=Galaxy+S24+Ultra",
				],
				categoryId: categories[0].id,
			},
		}),
		prisma.product.create({
			data: {
				...
				images: [
					"https://placehold.co/800x800/1e293b/white?text=Sony+WH-1000XM5",
				],
		...
		prisma.product.create({
			data: {
				...
				images: [
					"https://placehold.co/800x800/1e293b/white?text=PlayStation+5",
				],
