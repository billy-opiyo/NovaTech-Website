...
test("subscription lifecycle worker applies the configured fourteen-day grace period", () => {
	...
	assert.equal(trialEnded?.gracePeriodEndsAt?.toISOString(), "2026-09-03T00:00:00.000Z")
